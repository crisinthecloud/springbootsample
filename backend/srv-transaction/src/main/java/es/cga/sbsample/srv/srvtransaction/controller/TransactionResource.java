...
public class TransactionResource {
    ...
    public ResponseEntity<CreateTransaction_OUT> createTransaction(@RequestBody CreateTransaction_IN in)
            throws AppException {
    ...
    public ResponseEntity<ListTransaction_OUT> listTransaction(@RequestParam String filters)
            throws AppException {
